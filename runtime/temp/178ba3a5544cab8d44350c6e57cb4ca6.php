<?php /*a:1:{s:86:"E:\phpstudy\PHPTutorial\WWW\day-day-up\application\index\view\studentfinish\index.html";i:1543483421;}*/ ?>
<html>
...
<body>
    ...
    <?php if(is_array($details) || $details instanceof \think\Collection || $details instanceof \think\Paginator): $i = 0; $__LIST__ = $details;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$detail): $mod = ($i % 2 );++$i;?>
        ...
        <h4 style="color:red;"> 你的答案：<?php echo htmlentities($detail['answerContent']); ?></h4>
        <h4 style="color:red;">  <?php echo $detail["thisScore"]>0?"":$detail["right"]; ?></h4>
